...
func (t *Touch) HandleDown(serial, time, surfaceID uint32, id int32, x, y int32) {
}
...
func (t *Touch) HandleMotion(time uint32, id int32, x, y int32) {
}
...
func (t *Touch) HandleShape(id int32, major, minor int32) {
}
...
func (t *Touch) HandleOrientation(id int32, orientation int32) {
}
