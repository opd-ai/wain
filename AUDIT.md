...
- [ ] **Naming (Critical Weight):** Address 44 identifier violations — rename single-letter variables in non-loop contexts (primarily `x`/`y` in demo code outside tight arithmetic loops)
