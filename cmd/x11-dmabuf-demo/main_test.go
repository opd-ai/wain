...
// TestX11DmabufDemoCompiles is a smoke test verifying the binary compiles.
// Full functional testing requires GPU hardware and X11 server.
func TestX11DmabufDemoCompiles(t *testing.T) {
