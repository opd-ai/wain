...
// TestX11DemoCompiles is a smoke test verifying the binary compiles.
// Full functional testing requires a running X11 server.
func TestX11DemoCompiles(t *testing.T) {
