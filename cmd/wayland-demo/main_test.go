...
// TestWaylandDemoCompiles is a smoke test verifying the binary compiles.
// Full functional testing requires a running Wayland compositor.
func TestWaylandDemoCompiles(t *testing.T) {
